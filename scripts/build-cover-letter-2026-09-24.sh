#!/usr/bin/env bash
# Render docs/grant-cover-letter-2026-09-24.md to docs/grant-cover-letter-2026-09-24.pdf.
# Same header/logo treatment and CSS as build-grant-pdf.sh, one page, signature-ready.
set -euo pipefail
cd "$(dirname "$0")/.."
SRC=docs/grant-cover-letter-2026-09-24.md
HTML=out/grant-cover-letter-2026-09-24.html
PDF=docs/grant-cover-letter-2026-09-24.pdf
