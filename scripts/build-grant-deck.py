...
team = [
    ...
    ("assets/brand/team/van-wilson-hightechmortgage.png", "Dr Van Wilson", "Data Science, AI and Blockchain",
     ["Formerly U.S. Securities and Exchange Commission (SEC) and Fannie Mae", "MIT post-graduate program, AI and data science; CSU Fullerton BS", "AWS Certified Developer; Databricks; Blockchain Training Alliance; Microsoft Certified Trainer", "Certified PostgreSQL / SQL Server / MySQL DBA; Sage, QuickBooks, MS NAV", "35 years real-estate investor, $10M+ portfolio; built v2.0", "linkedin.com/in/drvanwilson"]),
