 ...
 * FHA model Note, FHA Idaho Deed of Trust, recorded Warranty Deed, plus the period-1
...
const jobs: Array<[string, () => Promise<number>]> = [
  ...
  ['08-fha-deed-of-trust-idaho.pdf', () => deedOfTrust(loan, read('03-fha-deed-of-trust-idaho.json'), out('08-fha-deed-of-trust-idaho.pdf'), anchor)],
...
const blanks: Array<[string, () => Promise<number>]> = [
  ...
  ['08-fha-deed-of-trust-idaho-blank.pdf', () => deedOfTrust(bl, blankOf(read('03-fha-deed-of-trust-idaho.json')), path.join(bdir, '08-fha-deed-of-trust-idaho-blank.pdf'), banchor)],
